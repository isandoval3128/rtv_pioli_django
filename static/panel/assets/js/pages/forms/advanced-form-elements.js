$(function() {
    ...
    // Colorpicker - solo si está disponible
    if ($.fn.colorpicker) {
        $('.colorpicker').colorpicker();
    }

    // Masked Input - solo si está disponible
    if ($.fn.inputmask) {
    ...
    // Masked Inputs con mask() - solo si está disponible
    if ($.fn.mask) {
    ...
    // Multiselect - solo si está disponible
    if ($.fn.multiselect) {
    ...
    // Multi-select con multiSelect - solo si está disponible
    if ($.fn.multiSelect) {
        $('#optgroup').multiSelect({ selectableOptgroup: true });
    }

    // noUISlider - solo si está disponible
    ...
    // Select2 - solo si está disponible (pero no inicializar globalmente para evitar conflictos)
    // La inicialización de Select2 se hace en js.js con cargarSelect2()

    // Date picker - solo si está disponible
    if ($.fn.datepicker) {
